      ...
      <table className="w-full text-sm text-left">
        <thead className="bg-muted text-muted-foreground text-xs uppercase font-semibold">
          <tr>
            ...
            <th className="px-6 py-4 hidden lg:table-cell text-center">Clicks</th>
            ...
            return (
              <tr key={product.id} className="hover:bg-muted/50 transition-colors">
                ...
                <td className="px-6 py-4 hidden sm:table-cell">
                  {badgeCfg ? (
                    <span className={`inline-block px-2 py-1 text-[10px] rounded-full font-bold tracking-wider ${badgeCfg.className}`}>
                ...
                <td className="px-6 py-4 hidden lg:table-cell text-center font-semibold text-foreground">
